function force_reporter = setup_ForceReporter(varargin)
...
V.AnalyzeTool.ATTRIBUTE.name = [Model '_' trial '_BK'];
...
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.ATTRIBUTE.name = 'ForceReporter';
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.on = AnalysisOn;
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.start_time = StartTime;
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.end_time = EndTime;
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.step_interval = StepInterval;
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.in_degrees = actuation_in_degrees;
V.AnalyzeTool.AnalysisSet.objects.ForceReporter.include_constraint_forces = 'true';
...
fileout = [data.Name '_Setup_ForceReporter.xml'];
