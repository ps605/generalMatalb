function joint_reaction = setup_JointReaction(varargin)
...
V.AnalyzeTool.ATTRIBUTE.name = [trial '_JR'];
...
V.AnalyzeTool.AnalysisSet.objects.JointReaction.ATTRIBUTE.name = 'JointReaction';
V.AnalyzeTool.AnalysisSet.objects.JointReaction.on = AnalysisOn;
V.AnalyzeTool.AnalysisSet.objects.JointReaction.start_time = StartTime;
V.AnalyzeTool.AnalysisSet.objects.JointReaction.end_time = EndTime;
V.AnalyzeTool.AnalysisSet.objects.JointReaction.step_interval = StepInterval;
V.AnalyzeTool.AnalysisSet.objects.JointReaction.in_degrees = actuation_in_degrees;
V.AnalyzeTool.AnalysisSet.objects.JointReaction.include_constraint_forces = 'true';
V.AnalyzeTool.AnalysisSet.objects.JointReaction.express_in_frame = reference_system;
V.AnalyzeTool.AnalysisSet.objects.JointReaction.apply_on_bodies = reference_system;
...
fileout = [data.Name '_Setup_JointReaction.xml'];
